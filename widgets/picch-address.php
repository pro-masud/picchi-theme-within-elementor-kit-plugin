...
class Picchi_Address extends \Elementor\Widget_Base{

	public function get_name() {
		return 'picchi_address';
	}

	public function get_title() {
		return esc_html__( 'Picchi Address', 'picchi_extrantion' );
	}
	...
	<div class="row">
		<div class="col-xl-6">
			<div class="single-contact">
				...
				<h4>address <span>1655 Market Street, CA 94103 New York </span></h4>
			</div>
		</div>
		<div class="col-xl-6">
			<div class="single-contact">
				<i class="fas fa-phone-alt"></i>
				<h4>phone <span>+(07) 012345678 </span></h4>
			</div>
		</div>
		<div class="col-xl-6">
			<div class="single-contact">
