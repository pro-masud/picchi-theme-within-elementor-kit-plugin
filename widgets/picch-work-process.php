...
class Picchi_work_process extends \Elementor\Widget_Base{

	public function get_name() {
		return 'picchi_work_process';
	}

	public function get_title() {
		return esc_html__( 'Picchi Work Process', 'picchi_extrantion' );
	}
	...
	protected function _content_template(){
		?>
		<div class="single-process">
			<h6>{{{settings.process_title}}} <span>{{{settings.process_number}}}</span></h6>
			<p>{{{settings.process_description}}}</p>
		</div>
